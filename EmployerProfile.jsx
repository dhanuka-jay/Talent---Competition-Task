...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        //console.log(process.env.SERVICE_PROFILE);
        $.ajax({
            url: `${process.env.SERVICE_PROFILE}/profile/profile/getEmployerProfile`,
            headers: {
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: `${process.env.SERVICE_PROFILE}/profile/profile/saveEmployerProfile`,
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
